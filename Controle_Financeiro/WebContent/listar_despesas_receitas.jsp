...
<html lang="pt-BR">
    ...
    <body>
    	...
    	<div class="container">
    		<header class="topo">
                <center><h1 class="display-4">Despesas x Receitas</h1></center>
                <hr>
            </header> <br><br>
    	</div>
        ...
        <div class="container">
            ...
            <tbody>
                <tr>
                   ...
                   <td><%= desp.getValor() %></td>
                   <td>
                   	   <a href="index_despesas.jsp?id=<%= desp.getIdDespesa() %>"  class="btn btn-primary" > Alterar</a>
                   	   <a href="excluir_despesa.jsp?id=<%= desp.getIdDespesa() %>"  class="btn btn-danger"> Excluir</a>
                   </td>
                 </tr>
             </tbody>
            <% 
